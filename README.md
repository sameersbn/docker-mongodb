...
This image is available as a [trusted build](//hub.docker.com/r/sameersbn/mongodb) on the [Docker hub](//hub.docker.com) and is the recommended method of installation.
